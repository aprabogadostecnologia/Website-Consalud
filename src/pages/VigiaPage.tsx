      ...
      <main className="relative z-10 pt-[72px]">
        <div className="w-full max-w-7xl xl:max-w-[1440px] mx-auto px-6 md:px-14 lg:px-16 2xl:px-24 pt-4 pb-20 md:pt-6 flex flex-col gap-16">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {FEATURES.map((feat, i) => (
                    <div key={i} className="flex items-start gap-3 bg-slate-50 border border-slate-200 rounded-xl p-3.5 hover:border-[#ff8d2b]/40 transition-colors duration-200">
                      <div className="mt-0.5 text-[#ff8d2b] shrink-0">{feat.icon}</div>
                      <div>
                        <p className="text-xs font-bold text-slate-900 mb-0.5">{feat.title}</p>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {GALLERY.map((img, i) => (
                <div
                  ...
                  className="group relative rounded-xl overflow-hidden border border-slate-200 hover:border-[#ff8d2b]/50 bg-slate-100 aspect-[4/3] cursor-zoom-in transition-all duration-300 hover:scale-[1.03] hover:shadow-[0_8px_20px_rgba(255,141,43,0.15)]"
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center z-20 opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none">
                    <div className="bg-white/90 border border-slate-200 p-2 rounded-full text-[#ff8d2b]">
                  ...
                  <div className="absolute bottom-2 left-2.5 right-2 z-20 text-left">
                    <span className="text-[7px] font-mono tracking-widest text-[#ff8d2b] uppercase font-bold bg-black/75 px-1.5 py-0.5 rounded border border-[#ff8d2b]/20">{img.label}</span>
          ...
          >
            ...
            <button
              onClick={() => navigate("/")}
              className="flex items-center justify-center gap-2 py-3.5 px-8 rounded-xl font-mono text-sm font-black uppercase tracking-widest border border-[#ff8d2b]/50 text-[#ff8d2b] hover:bg-[#ff8d2b]/10 hover:border-[#ff8d2b] active:scale-[0.98] transition-all cursor-pointer w-full sm:w-auto"
            >
              <ArrowLeft className="w-4 h-4" />
              Volver al Inicio
            </button>
